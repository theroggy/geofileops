...
if __name__ == "__main__":
    ...
    input_path = Path(
        r"X:\__IT_TEAM_ANG_GIS\Taken\2020\2020-04-09_FasterDissolve\GBG_woningen03.gpkg"
    )
    output_dir = Path(
        r"X:\__IT_TEAM_ANG_GIS\Taken\2020\2020-04-09_FasterDissolve\testje"
    )
    ...
    buildings_diss_buf50m_diss_path = (
        tmp_dir / f"{buildings_diss_path.stem}_buf50m_diss.gpkg"
    )
    gfo.dissolve(
    ...
    buildings_diss_buf100m_diss_path = (
        tmp_dir / f"{buildings_diss_path.stem}_buf100m_diss.gpkg"
    )
    gfo.dissolve(
