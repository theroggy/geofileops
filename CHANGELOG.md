...
- Improve performance of the subdividividing used in most two-layer operations (#730)
...
- For most general layer operation that update a file, if it fails because the file is
